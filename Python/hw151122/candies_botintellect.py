...
# Суть решения: 2021 делим по остатку на 29(28 максимум модет взять оппонент
# и 1 минимум можем взять мы). Остаток 20 конфет нужно взять, если ходим первыми. 
# Далее смотрим сколько взял конфет в каждом ходе второй игрок и бобираем до 29.
